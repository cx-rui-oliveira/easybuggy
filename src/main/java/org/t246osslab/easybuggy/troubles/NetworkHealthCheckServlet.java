...
@WebServlet(urlPatterns = { "/nethealthcheck" })
public class NetworkHealthCheckServlet extends AbstractServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            if (targetURL == null) {
                targetURL = req.getScheme() + "://" + req.getServerName() + ":" + req.getServerPort() + "/health";
            }
            ...
            bodyHtml.append("<td>" + targetURL + "</td></tr>");
